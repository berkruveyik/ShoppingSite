...
<div class="main">
  ...
  <header>
    <div class="box1">
        <div><img src="images/Alibaba-Logo-png.png" id="img"></div>
        ...
        <nav id="line">
            <ul id="main" onclick="showAlert()">
                ...
                <li><a href="#">sel on alibaba</a>
                    <ul>
                        <li><a href="">for global seller</a></li>
                        <li><a href="">for chinese seller</a></li>
...
<div id="myBtnContainer" >
  ...
  <button class="topnav" onclick="filterSelection('Digital Watches')"> Digital Watches</button>
  <button class="topnav" onclick="filterSelection('Fashion Smart Watches')"> Fashion Smart Watches</button>
  <button class="topnav" onclick="filterSelection('Mechanical Watches')"> Mechanical Watches</button>
</div>
